...
export const metadata: Metadata = generateMetadata({
  ...defaultSEO,
  title: "Chiropractic Adjustments | Midland Wellness Centre - Scarborough",
  description: "Expert chiropractic care in Scarborough. Professional spinal adjustments for pain relief, improved mobility, and overall wellness. Book your chiropractic appointment today.",
  keywords: "chiropractic scarborough, spinal adjustments, back pain treatment, chiropractor, spine health, wellness care",
  openGraph: {
    title: "Professional Chiropractic Care | Midland Wellness Centre",
    description: "Expert chiropractic adjustments for pain relief and improved wellness in Scarborough.",
  },
