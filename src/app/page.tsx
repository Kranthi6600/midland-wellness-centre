...
import ConditionsAndFAQ from "../../components/sections/home/ConditionsAndFAQ";
import { generateMetadata, defaultSEO } from "@/utils/metadata";
import type { Metadata } from "next";

export const metadata: Metadata = generateMetadata({
  ...defaultSEO,
  title: "Wellness Centre in Scarborough | Physiotherapy & Rehab Clinic",
  description: "Visit a top wellness centre in Scarborough for physiotherapy, chiropractic, massage & rehab. Book expert pain relief treatment today.",
