        ...
        <section className="portfolio-style-two p_relative">
            ...
            <div className="auto-container">
                <div className="sec-title centred mb_60">
                    ...
                    <p>Keeping healthy is important for a happy and active life. 🌱 Regular exercise, eating nutritious food, drinking enough water, and getting proper sleep help the body stay strong and prevent diseases.</p>
                </div>
